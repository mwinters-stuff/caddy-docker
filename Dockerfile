...
RUN wget https://github.com/caddyserver/caddy/releases/download/${CADDY_SOURCE_VERSION}/caddy_${CADDY_SOURCE_VERSION}_linux_${CADDY_ARCH}.tar.gz
RUN tar xvf caddy_${CADDY_SOURCE_VERSION}_linux_${CADDY_ARCH}.tar.gz
